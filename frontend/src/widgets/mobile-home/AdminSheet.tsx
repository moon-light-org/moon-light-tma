                    ...
                    {selectedLocationReviews.map((review) => (
                      <article key={review.id} className="location-review-item">
                        <div className="admin-review-head">
                          <span>{review.source === "btcmap" ? "BTCMap review" : review.payment_status === "lightning" ? "Accepts Lightning" : review.payment_status === "btc_only" ? "Accepts only BTC" : review.payment_status === "neither" ? "Accepts neither Lightning nor BTC" : "User review"}</span>
                          <button
                            type="button"
