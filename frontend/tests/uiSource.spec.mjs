...
const mainCategories = readFileSync("src/entities/location/model/mainCategories.ts", "utf8");
...
assert.match(locationDetail, /location-review-carousel/);
assert.match(locationDetail, /location-detail-verification/);
assert.match(locationDetail, /Not verified/);
...
assert.match(locationDetail, /location-detail-review-actions/);
...
assert.match(styles, /\.location-detail-review-actions\s*\{/);
...
assert.match(locationDetail, /out of 3 rating/);
...
assert.match(locationMap, /isPickingLocation/);
assert.match(locationMap, /if \(isPickingLocation\) onMapPickLocation/);
assert.match(locationMap, /mainCategory: location\.main_category/);
assert.match(locationMap, /isApproved: location\.is_approved/);
assert.match(locationMap, /registerMarkerImages/);
assert.match(locationMap, /rasterizeMarker/);
assert.match(locationMap, /getImageData/);
assert.match(locationMap, /POINT_FALLBACK_LAYER_ID/);
assert.doesNotMatch(locationMap, /map\.loadImage/);
assert.match(mainCategories, /"accommodation"/);
assert.match(mainCategories, /"bitcoin"/);
assert.match(mainCategories, /"food_drink"/);
assert.match(mainCategories, /"retail"/);
assert.match(mainCategories, /"services"/);
